...
class DecoderImg(nn.Module):
    def __init__(self, flags):
        ...
        self.feature_generator = nn.Linear(flags.style_m1_dim + flags.class_dim, flags.num_layers_img * flags.DIM_img, bias=True);
        self.img_generator = DataGeneratorImg(flags, a=flags.a_img, b=flags.b_img)
